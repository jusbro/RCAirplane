...
void processGamepad(ControllerPtr gamepad) {
  ...
  if (gamepad->x()) {
    // Set rumble for 1 second with moderate intensity
    gamepad->setRumble(0x80 /* force */, 255 /* duration */);
    sleep_ms(1000);  // Delay for 1 second to allow rumble effect
    gamepad->setRumble(0x00 /* force */, 0 /* duration */);  // Stop the rumble
}
